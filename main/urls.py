...
urlpatterns = [
    ...
    path('reading-group', views.reading_group_application, name='reading_group'),
    ...
    path('portal/reading-group', views.reading_group_management, name='reading_group_management'),
    path('portal/reading-group/delete/<int:application_id>/', views.delete_reading_group_application, name='delete_reading_group_application'),
    path('portal/reading-group/delete-all/', views.delete_all_reading_group_applications, name='delete_all_reading_group_applications'),
