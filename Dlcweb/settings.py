"""
Django settings for Dlcweb project.
...
INSTALLED_APPS = [
    ...
    # Cloudinary for file storage (add at the end)
    'cloudinary_storage',
    'cloudinary',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.user_stats',
            ],
        },
    },
]

WSGI_APPLICATION = 'Dlcweb.wsgi.application'
...
# Cloudinary Configuration for File Storage (Production)
if not DEBUG:
